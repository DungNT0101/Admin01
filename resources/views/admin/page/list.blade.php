...
<div class="page-head">
    <h4>
        <a href={{route('news.index')}}>Pages</a>
    </h4>
</div>
...
<div class="box-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="{{ route('page.create') }}" class="btn btn-primary mg-right-20">Tạo mới</a>
        </div>
    </div>
        ...
        <div class="col-md-12 border-bottom">
            <div class="row mg-none mg-top-20">
                ...
                <div class="col-md-2 border-top border-left border-bottom pd-5">
                    <h6 class="mg-none text-center">Từ khóa SEO</h6>
                </div>
                <div class="col-md-2 border-top border-left border-bottom pd-5">
            ...
            @foreach ($dataList as $data)
                <div class="row mg-none">
                    ...
                    <div class="col-md-2 border-left border-right border-bottom pd-5 text-center">
                        <a href="{{ route('page.edit', $data->id) }}" class="btn btn-primary mg-right-20">&#9998;</a>
                        <a href="{{ route('page.delete', [$data->id]) }}" class="btn btn-danger">&#10006;</a>
                    </div>
                </div>
            @endforeach
        </div>
