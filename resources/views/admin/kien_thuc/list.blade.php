...
<div class="page-head">
    <h4>
        <a href={{route('kienThuc.index')}}>Kiến Thức</a>
    </h4>
</div>
...
<div class="box-content">
    ...
    <div class="row">
        <div class="col-md-12">
            <a href="{{ route('kienThuc.create') }}" class="btn btn-primary mg-right-20">Tạo mới</a>
        </div>
    </div>
            ...
            @foreach ($dataList as $data)
                <div class="row mg-none">
                    ...
                    <div class="col-md-2 border-left border-right border-bottom pd-5 text-center">
                        <a href="{{ route('kienThuc.edit', $data->id) }}" class="btn btn-primary mg-right-20">&#9998;</a>
                        <a href="{{ route('kienThuc.delete', [$data->id]) }}" class="btn btn-danger">&#10006;</a>
                    </div>
                </div>
            @endforeach
        </div>
