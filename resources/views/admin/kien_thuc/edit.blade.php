...
<div class="page-head">
    <h4>
        <a href={{ route('kienThuc.edit', $data->id) }}>Kiến Thức</a>
    </h4>
</div>

<div class="box-content">
    <form action="{{ route('kienThuc.update') }}" enctype="multipart/form-data" method="POST">
        @csrf
        ...
        <div class="row mg-top-40">
            <div class="col-md-12 text-center">
                <a href="{{ route('kienThuc.index') }}" class="btn btn-primary">Quay lại</a>
